...
foreach($z as $i)
{
    ...
    { 
        ...
        file_put_contents($output_file . '_multihot.csv', multihot($pair) . ", " . $p[0] . "\n", FILE_APPEND | LOCK_EX);
        file_put_contents('train_x.dat', multihot_packed($pair), FILE_APPEND | LOCK_EX);
